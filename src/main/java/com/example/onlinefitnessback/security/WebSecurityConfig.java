...
public class WebSecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity httpSecurity) throws Exception {
        httpSecurity = httpSecurity.cors(withDefaults()).csrf(AbstractHttpConfigurer::disable).sessionManagement((session) -> session
    ...
    private HttpSecurity createAuthorizationRules(HttpSecurity http) throws Exception {
        ...
        interceptor = interceptor.requestMatchers(HttpMethod.POST, "/login").permitAll().
                requestMatchers(HttpMethod.POST, "/sign-up").permitAll().
                requestMatchers(HttpMethod.GET, "/activate").permitAll().
                requestMatchers(HttpMethod.GET, "/categories").permitAll().
                requestMatchers(HttpMethod.GET, "/categories/selected/{id}").permitAll().
                requestMatchers(HttpMethod.GET, "/programs").permitAll().
                requestMatchers(HttpMethod.GET, "/users/findByUsername/{username}").permitAll().
                requestMatchers(HttpMethod.GET, "/activities/{id}").permitAll().
                requestMatchers(HttpMethod.GET, "/programs/all-programs").permitAll().
                requestMatchers(HttpMethod.GET, "/programs/my-programs").permitAll().
                requestMatchers(HttpMethod.GET, "/programs/purchased-programs").permitAll().
                requestMatchers(HttpMethod.GET, "/attributes/{id}/values").permitAll().
                requestMatchers(HttpMethod.GET, "/attributes/category/{id}").permitAll().
                requestMatchers(HttpMethod.GET, "/categories/{id}/attributes").permitAll().
                requestMatchers(HttpMethod.GET, "/programs/{id}/attributes").permitAll().
                requestMatchers(HttpMethod.GET, "/messages/{userId}/{receiverId}").permitAll().
                requestMatchers(HttpMethod.GET, "/program-has-attributes/{idProgram}").permitAll().
                requestMatchers(HttpMethod.GET, "/programs/{id}/comments").permitAll().
                requestMatchers(HttpMethod.GET, "/categories/get-id-by-name").permitAll();
    ...
    public CorsFilter corsFilter() {
        ...
        corsConfiguration.setAllowedOrigins(List.of(FRONT_BASE_URL, "https://api.imgur.com")); // Omogući Imgur
